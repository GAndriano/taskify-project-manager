...
class task {
    constructor(title, desc, dueDate, done) {
        this.title = title
        this.desc = desc
...
const projects = [
    new task("Clean house","cleaning my room and basement", (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(2022, 4, 24), "yyyy-MM-dd"), false),
    new task("Get Job","get a fucking job", (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(2022, 5, 31), "yyyy-MM-dd"), false)
]
...
const makeProject = (() => {
    ...
    const renderAddBox = () => {
        ...
        box.addEventListener('click', () => {addForm(box)})
